...
export const configurePassport = () => {
    ...
    passport.use(new GoogleStrategy({
        ...
        callbackURL: process.env.NODE_ENV === 'production' ? process.env.GOOGLE_CALLBACK_URL! : '/api/auth/google/callback', // What Google sends users after login
    ...
    passport.use(new GitHubStrategy({
        ...
        callbackURL: process.env.NODE_ENV === 'production' ? process.env.GITHUB_CALLBACK_URL! : '/api/auth/github/callback',
        scope: ['user:email']
    }, async (
        _accessToken: string,
        _refreshToken: string,
