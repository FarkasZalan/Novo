...
export const createProjectService = async (name: string, description: string, user_id: string) => {
...
export const updateProjectService = async (name: string, description: string, id: string) => {
