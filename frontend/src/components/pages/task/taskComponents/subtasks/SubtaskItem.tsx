...
export const SubtaskItem: React.FC<SubtaskItemProps> = ({
    ...
    return (
        <div
            className={`${isExpanded ? 'cursor-default bg-gray-50 dark:bg-gray-700' : 'cursor-pointer '} group p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 dark:border-gray-700 ${subtask.status === 'completed' ? 'bg-green-50/30 dark:bg-green-900/10 border-green-100 dark:border-green-900/20' : ''}`}
            onClick={
                isExpanded ? undefined : handleClick
            }
        >
            <div className="flex items-start justify-between gap-4">
              ...
              ${subtask.status === "completed"
                ...
                {/* Right section with priority and chevron */}
