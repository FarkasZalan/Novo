        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    ...
                    <h2 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">About Novo Task Manager</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                        ...
                        <h3 className="text-xl font-semibold text-center text-gray-900 dark:text-white mb-4">About Novo</h3>
                        <p className="text-gray-600 dark:text-gray-300">
                            Novo is a sleek, intuitive task manager born from my passion for building tools that make life more organized.
                            Designed to help individuals and small teams stay on top of their projects, Novo combines simplicity with powerful
                            features to transform how you manage your work.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mt-4">
                            What makes Novo special is its clean interface and focus on what matters most - getting things done without
                    ...
                    <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            ...
                            in January 2025. I build projects like Novo to sharpen my skills and create tools I find useful in my own life.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mt-4">
                            When I'm not coding, you'll find me exploring new technologies, contributing to open source projects, or
                            brainstorming my next creation. Novo represents my journey from student to developer - a project built with
                ...
                <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8 mb-16">
                    <h3 className="text-2xl font-semibold text-center text-gray-900 dark:text-white mb-8">Why I Built Novo</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
                                Novo was my canvas to apply academic knowledge to a real-world application, blending theory with practice.
                            </p>
                        </div>
                ...
                <div className="text-center">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">The Future of Novo</h3>
                    <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6">
                        Novo is constantly evolving. As I grow as a developer, so will Novo - with new features, better performance,
