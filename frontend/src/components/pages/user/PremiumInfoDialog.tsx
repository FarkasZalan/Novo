    ...
    return (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200/80 dark:border-gray-700/50"
            >
                {/* Header */}
                <div className="p-6">
                ...
                <div className="px-6 pb-1">
                    <div className="relative bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl p-5 text-white h-48 shadow-lg border border-white/10 overflow-hidden">
                        {/* Card Chip */}
                        <div className="absolute top-5 left-5 bg-yellow-400/20 w-10 h-8 rounded-md flex items-center justify-center">
                            <div className="w-8 h-6 bg-yellow-400/30 rounded-sm border border-yellow-300/50"></div>
                        </div>
                        ...
                        <div className="absolute top-15 left-5 right-5">
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 text-xs hover:bg-white/10 px-2 py-1 rounded transition-colors group"
                                >
                                    {copied ? (
                            ...
                            <div
                                onClick={copyToClipboard}
                                className="font-mono text-xl tracking-wider bg-white/10 hover:bg-white/15 transition-colors rounded px-3 py-2 flex justify-between items-center cursor-pointer"
                            >
                                <span>4000 0034 8000 0005</span>
                                <FaCopy className="opacity-60 hover:opacity-90 transition-opacity" />
                            </div>
                        </div>
                        ...
                        <div className="absolute inset-0 pointer-events-none">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full transform translate-x-20 -translate-y-20"></div>
                ...
                {/* Info */}
                <div className="p-6 pt-4 text-sm text-gray-600 dark:text-gray-300">
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 flex justify-end gap-3 border-t border-gray-100 dark:border-gray-800">
                    <button
                        onClick={onClose}
                        className="px-4 py-2.5 text-sm cursor-pointer font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="px-4 py-2.5 bg-indigo-600 cursor-pointer hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
                    >
